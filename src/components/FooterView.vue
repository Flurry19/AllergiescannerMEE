<template> <footer style="background-color: #EF761F; display: flex; justify-content: space-around; align-items: center; height: 60px; position: fixed; width: 100%; bottom: 0;">
