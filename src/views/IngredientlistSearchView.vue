<template>
  <div>
    <div class="pt-80">
      <div style="padding: 10px; background: #EE9250; margin-left: 200px; margin-right: 200px">
        <div style="text-align: center; margin: 20px;">
          <div style="display: flex; align-items: center; justify-content: center;">
            <input type="text" placeholder="Noten" id="searchBar" style="border-radius: 20px 0 0 20px; background-color: #EF761F; padding: 2px; color: white">
        ...
        <h1 style="text-align: center; margin: 10px; font-size: 24px; font-weight: bold;">Uw zoekresultaten voor: "Noten"</h1>
