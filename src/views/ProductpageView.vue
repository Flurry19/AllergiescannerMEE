  ...
  mounted() {
    ...
    fetch(url)
        ...
        .then(productInfo => {
          ...
          this.ingredients = productInfo.product.ingredients_text_en;
...
<!--      </div>-->
    ...
    class="font-bold text-center text-white text-3xl">
      <div class="lg:flex-row lg:flex ">
          ...
          <div id="app">
            ...
            <div v-if="isModalNutriVisible">
              <div
                  @click="onToggleNutri"
              ></div>
              <div class="w-full max-w-[350px] relative mx-auto my-auto rounded-xl shadow-lg bg-white">
                <div>
          ...
          <div id="app">
            ...
            <div id="app">
              ...
              <div v-if="isModalEcoVisible">
                ...
                >
                  <div>
                    <div class="text-center p-3 flex-auto justify-center max-w-[350px]">
        ...
        <div class="bg-white lg:m-4 my-4 lg:mx-4 lg:w-1/3 p-4 rounded-xl text-black">
          <h2 class="font-bold text-2xl">Voedingswaarden (per portie)</h2>
          <div class="flex flex-row text-xl">
            <div class="w-5/12 font-normal">
              <ul>
                <li>Portiegrootte:</li>
                <li>Energie:</li>
                <li>Vet:</li>
        ...
        <div class="bg-white lg:my-4 text-xl rounded-xl p-4 lg:w-6/12 text-black">
          <h2 class="font-bold text-2xl">Alle ingrediënten:</h2>
          <p class="font-normal">{{ingredients}}</p>
        </div>
      </div>
    </AccordionPanel>
